...
Starting with *Plugin Notes 1.5* you can save a note as a template for new notes, use [markdown syntax](http://daringfireball.net/projects/markdown/syntax) and use a number of variables in the notes. Please have a look at the [FAQ](http://wordpress.org/extend/plugins/plugin-notes/faq/) for more information about these features.

...
if ( class_exists( 'Plugin_Notes' ) && ! class_exists( 'Plugin_Notes_Display_Notes_Plain' ) ) {
	/**
	 * @package		WordPress\Plugins\Plugin Notes
	 * @subpackage	Display Notes Plain
	 * @version		2.0
	 ...
	 */
	class Plugin_Notes_Display_Notes_Plain extends Plugin_Notes_Display_Notes {

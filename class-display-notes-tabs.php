...
if ( class_exists( 'Plugin_Notes' ) && ! class_exists( 'Plugin_Notes_Display_Notes_Tabs' ) ) {
	/**
	 * @package		WordPress\Plugins\Plugin Notes
	 * @subpackage	Display Notes Tabs
	 * @version		2.0
	 ...
	 */
	class Plugin_Notes_Display_Notes_Tabs extends Plugin_Notes_Display_Notes {
